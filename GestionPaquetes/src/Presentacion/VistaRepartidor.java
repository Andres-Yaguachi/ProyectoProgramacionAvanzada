...
public class VistaRepartidor extends JPanel {
    ...
    public VistaRepartidor(VistaPrincipal base) {
        ...
        btnAsignados.addActionListener(e -> base.cambiarVista("PAQUETES_ASIGNADOS"));
        btnEntrega.addActionListener(e -> base.cambiarVista("REGISTRAR_ENTREGA"));
        ...
        JButton btnCerrar = crearBotonPequeno("Cerrar Sesión", new Color(100, 100, 100));
